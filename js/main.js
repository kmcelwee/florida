...
$(document).ready(() => {
	$.getJSON("https://raw.githubusercontent.com/kmcelwee/florida/master/fm.json", function(data) {
		fm = data;
		$('#man_count').text(`(${fm.count})`)
	});
	$.getJSON("https://raw.githubusercontent.com/kmcelwee/florida/master/fw.json", function(data) {
		fw = data;
